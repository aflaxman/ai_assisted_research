...
MIRROR = pd.DataFrame([
    ...
    ("UPM/Segob repatriation events", "CY2023", 215,
     "removal/return EVENTS at INM points (incl. repeat crossers)"),
    ("UPM/Segob repatriation events", "CY2024", 206, "same"),
    ("UPM/Segob repatriation events", "CY2025", 160,
     "same; DOWN 22% from 2024; ~15k voluntary per Segob"),
